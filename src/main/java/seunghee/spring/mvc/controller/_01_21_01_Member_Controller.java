...
import seunghee.spring.mvc._01_21_01_Member4.Member_ServiceImpl;
import seunghee.spring.mvc._01_21_01_Member4.Member_VO;

@Controller
public class _01_21_01_Member_Controller {
    ...
    public String member() {
        return "01_21_01_Member4/member";
    }
    ...
    public ModelAndView memberok(Member_VO mvo) {
        ...
        mv.setViewName("01_21_01_Member4/memberok");
    ...
    public ModelAndView memberlist() {
        ...
        mv.setViewName("01_21_01_Member4/memberlist");
    ...
    public ModelAndView memberview(String userid) {
        ...
        mv.setViewName("01_21_01_Member4/memberview");
    ...
    public ModelAndView memberupd(String userid) {
        ...
        mv.setViewName("01_21_01_Member4/memberupd");
        mv.addObject("mvo", msrv.readOneMember(userid));
