...
<div class="main margin30">
    ...
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item disabled">
            <button type="button" class="btn btn-light btn-sm" disabled>실명확인</button>
        </li>
        <li class="breadcrumb-item disabled">
    ...
    <div class="margin100">
        <h2>사이트 약관동의</h2>
        <small class="text-muted">회원가입을 위하여 아래 사이트 이용약관 &middot;
            개인정보 수집 및 이용에 대한 안내를 읽고 동의해 주세요</small>
    </div>
