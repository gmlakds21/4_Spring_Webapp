...
<div class="main margin30">
    ...
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item disabled">
            <button type="button" class="btn btn-light btn-sm" disabled>정보입력</button>
        </li>
        <li class="breadcrumb-item disabled">
        ...
        <form>
            ...
            <div class="row margin30">
                <div class="col-12 text-center">
                    <button type="button" id="checkbtn" class="btn btn-primary"><i class="bi bi-check"></i> 확인하기
                    </button>
    ...
    <div class="card card-body bg-light margin1050">
        ...
        <form>
                ...
                <div class="col-5">
                    <ul class="text-primary font-weight-bold">
                        ...
                        <li>타인의 주민등록 번호를 임의로 사용하면 <span class="text-danger">'주민등록법'에 의해
                                    3년 이하의 징역 또는 1천만원 이하의 벌금</span>이 부과될 수 있습니다.
                        </li>
                        <li>입력하신 주민등록번호는 <span class="text-danger">별도 저장되지 않으며,
                                    신용평가기관을 통한 실명확인용</span>으로만 이용됩니다.
                        </li>
            ...
            <div class="row margin30">
                <div class="col-12 text-center">
                    <button type="button" id="checkbtn2" class="btn btn-primary"><i class="bi bi-check"></i> 확인하기
                    </button>
